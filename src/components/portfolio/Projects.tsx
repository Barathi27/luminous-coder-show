...
const projects = [
  {
    ...
    desc: "Edge-first product analytics with sub-second queries on a billion-row dataset.",
    stack: ["TypeScript", "ClickHouse", "Cloudflare"],
    href: "#",
  },
  {
    img: p2,
    tag: "Fintech · 2024",
    title: "Orbit Wallet",
    desc: "Consumer wallet redesign that lifted weekly active users by 38% in a quarter.",
  ...
  },
  {
    ...
    tag: "DevTools · 2024",
    title: "Forge CLI",
    desc: "A terminal-first scaffolding tool with a plugin system used by 8k+ developers.",
    stack: ["Rust", "WASM", "Ink"],
    href: "#",
  },
];
